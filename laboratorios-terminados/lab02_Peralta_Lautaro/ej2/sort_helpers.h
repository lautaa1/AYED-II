...
/* Permutes elements of a[izq..der] and returns pivot such that:
   ...
   Permuta elementos de a[izq..der] y devuelve pivote tal que:
     - izq <= pivote <= der
     - elementos en a[izq,pivote) todos 'go_before' (según la función goes_before) a[pivote]
     - a[pivote] 'goes_before' todos los elementos en a(pivote,der]
*/
